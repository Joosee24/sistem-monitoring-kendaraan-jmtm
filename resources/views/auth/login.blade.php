...
<body class="me-0 overflow-hidden">
    <div class="container d-flex flex-column align-items-center justify-content-center min-vh-100">
        <form class="bg-white-transparent border border-dark rounded shadow p-5 d-flex flex-column align-items-center"
            ...
            <button type="submit" class="btn btn-primary w-100 mt-3"><a href="#" class="text-light text-decoration-none">Login</a></button>
        </form>
    </div>
    <footer class="text-center">
        <p class="text-light">Event JMTM by IT GA<a href="https://www.jmtm.co.id" class="text-light">Jasamarga Tollroad Maintenance</a> ©
        2024</p>
